...
cd /home/karen/Documents/cactus/tests/build && CACTUS_CAPTURE_STDOUT=0 CACTUS_CAPTURE_FILE=lfm2vl_capture.txt ./test_lfm2vl_model ../../weights/lfm2-vl-350m-fp16 ../monkey-nose-muzzle-wallpaper.png