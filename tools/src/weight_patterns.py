...
MOONSHINE_GLOBAL_WEIGHTS = [
    ...
    ('encoder.conv3.weight', 'encoder_conv3_weight.weights'),
    ('encoder.conv3.bias', 'encoder_conv3_bias.bias'),
    ('encoder.groupnorm.weight', 'encoder_norm_weight.weights'),
    ('encoder.groupnorm.bias', 'encoder_norm_bias.bias'),
    ('encoder.layer_norm.weight', 'encoder_layer_norm_weight.weights'),
    ('encoder.layer_norm.bias', 'encoder_layer_norm_bias.bias'),
