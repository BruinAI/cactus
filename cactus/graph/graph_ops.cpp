        ...
        case OpType::ATTENTION: {
            ...
            if (query_buffer.precision == Precision::INT8) {
                ...
                cactus_attention_int8(query_buffer.data_as<int8_t>(), key_buffer.data_as<int8_t>(),
                                      ...
                                      q_scale, k_scale, v_scale, output_scale, node.params.position_offset, node.params.window_size, node.params.is_causal);
                ...
                cactus_attention_f16(query_buffer.data_as<__fp16>(), key_buffer.data_as<__fp16>(),
                                     ...
                                     batch_size, seq_len, kv_seq_len, num_q_heads, num_kv_heads, head_dim, node.params.scale, nullptr, node.params.position_offset, node.params.window_size, node.params.is_causal);
