...
size_t WhisperModel::build_attention(CactusGraph* gb, size_t normalized_input, uint32_t layer_idx,
...
size_t WhisperModel::build_mlp(CactusGraph* gb, size_t input, uint32_t layer_idx,
