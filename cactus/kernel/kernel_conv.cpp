    ...
    for (size_t n = 0; n < N; ++n) {
        ...
        for (size_t c = 0; c < C; ++c) {
            ...
            for (size_t t0 = 1; t0 < L-1; t0 += T_TILE_F32) {
                ...
                float a0_0 = 0.f, a1_0 = 0.f, a2_0 = 0.f;
                float a0_1 = 0.f, a1_1 = 0.f, a2_1 = 0.f;
                {
                    ptrdiff_t xt0 = (ptrdiff_t)t0 - (ptrdiff_t)((k + 3) * dilation);
                    ptrdiff_t xt1 = (ptrdiff_t)t0 - (ptrdiff_t)((k + 4) * dilation);
                    ptrdiff_t xt2 = (ptrdiff_t)t0 - (ptrdiff_t)((k + 5) * dilation);
                    
                    if (xt0 >= 0) a0_0 = input[(size_t)xt0 * C + c];
                    if (xt1 >= 0) a1_0 = input[(size_t)xt1 * C + c];
                    if (xt2 >= 0) a2_0 = input[(size_t)xt2 * C + c];

                    ptrdiff_t yu0 = (ptrdiff_t)t1 - (ptrdiff_t)((k + 3) * dilation);
                    ptrdiff_t yu1 = (ptrdiff_t)t1 - (ptrdiff_t)((k + 4) * dilation);
                    ptrdiff_t yu2 = (ptrdiff_t)t1 - (ptrdiff_t)((k + 5) * dilation);
                ...
                float32x4_t xv1 = {a0_0, a1_0, a2_0, 0.f};
                float32x4_t yv1 = {a0_1, a1_1, a2_1, 0.f};
